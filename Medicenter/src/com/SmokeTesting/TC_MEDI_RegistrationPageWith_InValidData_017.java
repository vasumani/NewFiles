...
public class TC_MEDI_RegistrationPageWith_InValidData_017 {
	WebDriver driver;
	...
	WebElement register;
 public TC_MEDI_RegistrationPageWith_InValidData_017(WebDriver driver){
...
//	
	...
	Mobile_number.sendKeys("0000000000");
	Email.sendKeys("xxxxxxxx@gmail.com");
	Address.sendKeys("xxxxxxx");
	password.sendKeys("xxxxxxx");
	Retype_password.sendKeys("xxxx");
	upload.click();
