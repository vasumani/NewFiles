...
public class TC_MEDI_OTC_Womens_Care {
	WebDriver driver;
	...
	WebElement logout;
	public TC_MEDI_OTC_Womens_Care(WebDriver driver) {
		PageFactory.initElements(driver, this);
	}
	public void womenscare(WebDriver driver) throws InterruptedException{
		...
		w.until(ExpectedConditions.elementToBeClickable(Womens_Care)).click();
...
//    	String s2=md.getdata("Sheet1",1,5);
 ...
 public void womens(WebDriver driver) throws InterruptedException
	{
