...
public class TC_MEDI_OTC_FirstAid {
	WebDriver driver;
	...
	WebElement logout;
	public TC_MEDI_OTC_FirstAid(WebDriver driver){
		PageFactory.initElements(driver, this);
	}
	public void firstaid(WebDriver driver) throws InterruptedException{
...
//    	String s2=md.getdata("Sheet1",1,5);
 ...
 public void First(WebDriver driver) throws InterruptedException
	{
		cart.click();
		Thread.sleep(1000);
		quantity.clear();
