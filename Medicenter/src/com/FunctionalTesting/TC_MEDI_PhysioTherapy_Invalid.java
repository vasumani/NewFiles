...
public class TC_MEDI_PhysioTherapy_Invalid {
	WebDriver driver;
	...
	WebElement submit;
	public TC_MEDI_PhysioTherapy_Invalid(WebDriver driver) {
		this.driver=driver;
...
//		String s2=md.getdata("Sheet1",1,5);
	...
	public void register(WebDriver driver) throws InterruptedException, IOException{
//		Data_Driven_design md=new Data_Driven_design();
//		String s1=md.getdata("Sheet1",1,3);
//		String s2=md.getdata("Sheet1",1,5);
...
//		String s6=md.getdata("Sheet1",1,5);
		...
		ScreenShot.main(driver, "TC_MEDI_PhysioTherapy_Invalid");
